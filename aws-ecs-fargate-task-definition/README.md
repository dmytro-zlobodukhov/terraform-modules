...
# This module was developed by [Julian Nonino](https://github.com/jnonino) from [cn-terraform](https://github.com/cn-terraform) and initially taken [here](https://github.com/cn-terraform/terraform-aws-ecs-fargate-task-definition).
